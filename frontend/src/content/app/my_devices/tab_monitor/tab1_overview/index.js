    ...
    <Box>
      ...
      <Grid container row-gap={1} spacing={3} flexWrap="wrap">
        ...
        <StatisticsCard
          ...
          heading6_value={
            device.mode_routes == 0
              ? 'MQTT'
              : device.mode_routes == 1
              ? 'HTTP'
              : device.mode_routes == 2
              ? 'MQTTS'
              : 'HTTPS'
          }
          // heading6_key={'Module'}
        ...
        {device.wifi_status == 0 ? (
          ...
          <StatisticsCard
            ...
            heading10_key={
              device.mode_routes == 0 || device.mode_routes == 2
                ? 'Broker Status'
                : 'Server Status'
            }
            heading10_value={
              device.mode_routes == 0 || device.mode_routes == 2
                ? enable_disable(device.mqtt_status)
                : enable_disable(device.http_status)
            }
            heading11_key={
              device.mode_routes == 0 || device.mode_routes == 2
                ? 'Broker URL'
